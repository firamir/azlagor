...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CCitadelModifier> m_TrapModifier; // 0x1910		
		CEmbeddedSubclass<server::CCitadelModifier> m_DebuffModifier; // 0x1920		
		CEmbeddedSubclass<server::CCitadelModifier> m_DotModifier; // 0x1930		
		CEmbeddedSubclass<server::CCitadelModifier> m_SlowModifier; // 0x1940		
	};
};
