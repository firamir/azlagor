...
namespace source2sdk::server
{
	...
	public:
		CHandle<server::CBaseEntity> m_hRevengeTarget; // 0x1220		
	private:
		[[maybe_unused]] uint8_t __pad1224[0xc]; // 0x1224
	public:
		...
		CUtlVector<CHandle<server::CBaseEntity>> m_vecThreats; // 0x1250		
	private:
		[[maybe_unused]] uint8_t __pad1268[0x154]; // 0x1268
	public:
		// MNetworkEnable
		// MNetworkUserGroup "LocalPlayerExclusive"
	...
	private:
		[[maybe_unused]] uint8_t __pad1424[0x2c]; // 0x1424
	public:
		server::CCitadelPlayerBot* m_pBot; // 0x1450		
	private:
		[[maybe_unused]] uint8_t __pad1458[0x168]; // 0x1458
	public:
