...
namespace source2sdk::server
{
	...
	{
	private:
		[[maybe_unused]] uint8_t __pad1600[0x8]; // 0x1600
	public:
		// MNetworkEnable
		int32_t m_iLane; // 0x1608		
		int32_t m_iLaneSlot; // 0x160c		
	private:
		[[maybe_unused]] uint8_t __pad1610[0x20]; // 0x1610
	public:
		CHandle<server::CInfoTrooperBossSpawn> m_hSpawnWaveController; // 0x1630		
		CHandle<server::CBaseEntity> m_hTrooperSpawnPoint; // 0x1634		
	private:
		[[maybe_unused]] uint8_t __pad1638[0x20]; // 0x1638
	public:
		CModifierHandleTyped<server::CCitadelModifier> m_hNearDeathModifier; // 0x1658		
	private:
		[[maybe_unused]] uint8_t __pad1670[0x8]; // 0x1670
	public:
		// MNetworkEnable
		CHandle<server::CBaseEntity> m_hTargetedEnemy; // 0x1678		
		// MNetworkEnable
		// MNetworkBitCount "8"
