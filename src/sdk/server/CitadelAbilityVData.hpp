...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CBaseModifier> m_AutoChannelModifier; // 0x1508		
		CEmbeddedSubclass<server::CBaseModifier> m_AutoCastDelayModifier; // 0x1518		
		CUtlVector<CEmbeddedSubclass<server::CBaseModifier>> m_AutoIntrinsicModifiers; // 0x1528		
	};
};
