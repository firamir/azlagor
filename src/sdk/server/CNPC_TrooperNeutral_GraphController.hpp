...
namespace source2sdk::server
{
	...
	{
	public:
		CAnimGraphParamOptionalRef<bool> m_bShielded; // 0x5e0		
		CAnimGraphParamOptionalRef<bool> m_bAlert; // 0x600		
		CAnimGraphParamOptionalRef<char*> m_pszAttackLeanPosition; // 0x620		
		CAnimGraphParamOptionalRef<char*> m_pszOrbDrop; // 0x648		
		CAnimGraphParamOptionalRef<bool> m_bHeavyMelee; // 0x670		
