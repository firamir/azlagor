...
namespace source2sdk::server
{
	...
	{
	public:
		CAnimGraphParamOptionalRef<int32_t> m_nHitLayerTrigger; // 0x578		
		CAnimGraphParamOptionalRef<char*> m_pszDamageState; // 0x598		
		CAnimGraphParamOptionalRef<float> m_fHealth; // 0x5c0		
