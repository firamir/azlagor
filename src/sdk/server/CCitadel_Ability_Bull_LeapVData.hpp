...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CCitadelModifier> m_BoostModifier; // 0x1580		
		CEmbeddedSubclass<server::CCitadelModifier> m_CrashModifier; // 0x1590		
		CEmbeddedSubclass<server::CCitadelModifier> m_ImmunityModifier; // 0x15a0		
		CEmbeddedSubclass<server::CCitadelModifier> m_LandingBonusesModifier; // 0x15b0		
