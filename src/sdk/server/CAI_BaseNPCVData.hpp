#pragma once
#include "client/CAI_BaseNPC_DestructiblePartHitGroupInfoAndData.hpp"
...
namespace source2sdk::server
{
	...
	public:
		CUtlVector<CEmbeddedSubclass<server::CCitadelModifier>> m_vecIntrinsicModifiers; // 0x130		
	...
	public:
		...
		CUtlOrderedMap<client::HitGroup_t,client::CAI_BaseNPC_DestructiblePartHitGroupInfoAndData> m_DestructiblePartsDataByHitGroup; // 0x1d0		
	...
	private:
		[[maybe_unused]] uint8_t __pad01fa[0x2]; // 0x1fa
	public:
	...
	public:
		...
		CUtlVector<CGlobalSymbol> m_vecActionDesiredShared; // 0x208		
