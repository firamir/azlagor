...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CCitadelModifier> m_SilenceProcModifier; // 0x648		
		CEmbeddedSubclass<server::CCitadelModifier> m_SilenceActiveModifier; // 0x658		
		CEmbeddedSubclass<server::CCitadelModifier> m_ImmunityModifier; // 0x668		
