...
namespace source2sdk::server
{
	...
	private:
		[[maybe_unused]] uint8_t __pad1618[0x8]; // 0x1618
	public:
		// MNetworkEnable
		CHandle<server::CBaseEntity> m_hTargetedEnemy; // 0x1620		
		// MNetworkEnable
		entity2::GameTime_t m_flFadeOutStart; // 0x1624		
		// MNetworkEnable
		entity2::GameTime_t m_flFadeOutEnd; // 0x1628		
	private:
		[[maybe_unused]] uint8_t __pad162c[0x24]; // 0x162c
	public:
		// MNetworkEnable
	...
	private:
		[[maybe_unused]] uint8_t __pad1660[0x28]; // 0x1660
	public:
