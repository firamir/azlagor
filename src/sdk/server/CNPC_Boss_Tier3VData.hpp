...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CBaseModifier> m_LaserBeamModifier; // 0x1430		
		CEmbeddedSubclass<server::CBaseModifier> m_DyingModifier; // 0x1440		
		CEmbeddedSubclass<server::CBaseModifier> m_VulnerableModifier; // 0x1450		
		CEmbeddedSubclass<server::CBaseModifier> m_Phase1Modifier; // 0x1460		
		CEmbeddedSubclass<server::CBaseModifier> m_Phase2Modifier; // 0x1470		
		CEmbeddedSubclass<server::CBaseModifier> m_BackdoorProtection; // 0x1480		
		CEmbeddedSubclass<server::CBaseModifier> m_ObjectiveRegen; // 0x1490		
