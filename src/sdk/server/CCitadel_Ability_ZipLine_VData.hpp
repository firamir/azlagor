...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CCitadelModifier> m_RidingZipLineModifier; // 0x1bb8		
		CEmbeddedSubclass<server::CCitadelModifier> m_KnockedOffSlowModifier; // 0x1bc8		
		CEmbeddedSubclass<server::CCitadelModifier> m_ZipLineIntroModifier; // 0x1bd8		
		CEmbeddedSubclass<server::CCitadelModifier> m_ZipLineKnockdownImmuneModifier; // 0x1be8		
		CEmbeddedSubclass<server::CCitadelModifier> m_ZipLineSlowModifier; // 0x1bf8		
