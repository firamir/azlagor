...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CCitadelModifier> m_ImpactModifier; // 0x1be0		
		CEmbeddedSubclass<server::CCitadelModifier> m_DamagePreventionModifier; // 0x1bf0		
		CEmbeddedSubclass<server::CCitadelModifier> m_RollingModifier; // 0x1c00		
