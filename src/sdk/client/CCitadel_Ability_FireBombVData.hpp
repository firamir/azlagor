...
namespace source2sdk::client
{
	...
	public:
		...
		CEmbeddedSubclass<client::CCitadelModifier> m_ProgressBarModifier; // 0x1630		
		CEmbeddedSubclass<client::CCitadelModifier> m_FireBombModifier; // 0x1640		
		CEmbeddedSubclass<client::CCitadelModifier> m_DebuffModifier; // 0x1650		
	};
};
