...
namespace source2sdk::client
{
	...
	public:
		...
		CEmbeddedSubclass<client::CCitadelModifier> m_FlyingModifier; // 0x1540		
		CEmbeddedSubclass<client::CCitadelModifier> m_GrabModifier; // 0x1550		
		CEmbeddedSubclass<client::CCitadelModifier> m_HoldBombModifier; // 0x1560		
		CEmbeddedSubclass<client::CCitadelModifier> m_DroppedBuffModifier; // 0x1570		
		CEmbeddedSubclass<client::CCitadelModifier> m_ExplodingAllyModifier; // 0x1580		
		CEmbeddedSubclass<client::CCitadelModifier> m_AoEModifier; // 0x1590		
