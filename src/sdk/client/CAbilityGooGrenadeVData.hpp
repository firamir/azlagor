...
namespace source2sdk::client
{
	...
	public:
		...
		CEmbeddedSubclass<client::CCitadelModifier> m_GooGrenadeImpactModifier; // 0x1540		
		CEmbeddedSubclass<client::CCitadelModifier> m_GooGrenadePuddleAuraModifier; // 0x1550		
