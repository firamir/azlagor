...
namespace source2sdk::client
{
	...
	public:
		...
		CEmbeddedSubclass<client::CCitadelModifier> m_BackdoorProtectionModifier; // 0x1630		
		CEmbeddedSubclass<client::CCitadelModifier> m_BackdoorBulletResistModifier; // 0x1640		
		CEmbeddedSubclass<client::CCitadelModifier> m_ObjectiveRegen; // 0x1650		
